...
IGNORED_SELECTORS = {
  ...
  Primer::Alpha::Banner => ["Banner-message", "Banner-title", "Banner-visual", "Banner-close", "flash", "octicon", "octicon-bell", "Banner-actions", "Button--medium", "Banner--error", "Banner--success", "Banner--warning", "Banner--full"],
