...
class DeprecatedComponentsCounterTest < ErblintTestCase
  ...
  def test_warns_about_deprecated_primer_component
    ...
    assert_equal "'Primer::BlankslateComponent' has been deprecated. Please update your code to use 'Primer::Beta::Blankslate' or use rubocopy's auto-correct option to do it for you.", @linter.offenses[0].message
