...
class RubocopDeprecatedComponentsTest < CopTestCase
  ...
  def test_raises_offense_if_calling_legacy_component
    ...
    assert_equal "'Primer::Tooltip' has been deprecated. Please update your code to use 'Primer::Alpha::Tooltip' or use rubocopy's auto-correct option to do it for you.", cop.offenses[0].message
    assert_equal "'Primer::BlankslateComponent' has been deprecated. Please update your code to use 'Primer::Beta::Blankslate' or use rubocopy's auto-correct option to do it for you.", cop.offenses[1].message
  end
  ...
  def test_suggests_alternative_component_if_available
    ...
    assert_equal 1, cop.offenses.count
    assert_equal "'Primer::Tooltip' has been deprecated. Please update your code to use 'Primer::Alpha::Tooltip' or use rubocopy's auto-correct option to do it for you.", cop.offenses.first.message
  end
end
