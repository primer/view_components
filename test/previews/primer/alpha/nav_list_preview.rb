...
module Primer
  module Alpha
    ...
    class NavListPreview < ViewComponent::Preview
      ...
      # @label Sub lists
      def sub_lists
        render(Primer::Alpha::NavList.new(aria: { label: "Navigation list" })) do |list|
          list.with_heading(title: "Heading", tag: :h2)
          list.with_item(label: "Item one", href: "/") do |item|
            item.with_leading_visual_icon(icon: :gear)
          end
          list.with_list(aria: { label: "Navigation list" }) do |sub_list|
      ...
      def default(
        role: Primer::Alpha::NavList::DEFAULT_ROLE,
        scheme: Primer::Alpha::NavList::DEFAULT_SCHEME,
        show_dividers: false
      )
      ...
      def divider(
        scheme: Primer::Alpha::NavList::Divider::DEFAULT_SCHEME
      )
        render(Primer::Alpha::NavList::Divider.new(scheme: scheme))
      end
      ...
      def heading(
        scheme: Primer::Alpha::NavList::Heading::DEFAULT_SCHEME,
        title: "This is a title",
        section_id: "unique-id",
        subtitle: "This is a subtitle"
      )
        render(Primer::Alpha::NavList::Heading.new(list_id: "abc123", scheme: scheme, section_id: section_id, title: title, subtitle: subtitle))
      end
      ...
      def item(
        ...
        href: nil,
        size: Primer::Alpha::NavList::Item::DEFAULT_SIZE,
        scheme: Primer::Alpha::NavList::Item::DEFAULT_SCHEME,
        disabled: false,
        description: nil,
        description_scheme: Primer::Alpha::NavList::Item::DEFAULT_DESCRIPTION_SCHEME,
        active: false,
        expanded: false,
        ...
        list = Primer::Alpha::NavList.new(aria: { label: "Action List" })
        list.item(
          label: label,
