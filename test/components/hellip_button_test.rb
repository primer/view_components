...
class PrimerHellipButtonTest < Minitest::Test
  ...
  def test_renders
    ...
    assert_selector("button[type='button'][aria-expanded='false'].hellip-button", text: "…")
  end
  ...
  def test_renders_button_custom_classes
    ...
    assert_selector("button[type='button'][aria-expanded='false'].hellip-button.custom-class", text: "…")
  end
