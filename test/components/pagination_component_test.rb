...
class Primer::PaginationComponentTest < Minitest::Test
  ...
  def test_renders_a_pagination_container
    render_inline(Primer::PaginationComponent.new(page: 1, page_count: 1))
  ...
  def test_does_not_render_numbers_if_show_pages_is_false
    render_inline(Primer::PaginationComponent.new(page: 1, page_count: 10, show_pages: false))
  ...
  def test_defaults_to_rendering_1_first_and_last_pages
    render_inline(Primer::PaginationComponent.new(page: 5, page_count: 10))
  ...
  def test_renders_n_first_and_last_pages_when_specified
    n = 3
    render_inline(Primer::PaginationComponent.new(page: 10, page_count: 20, margin_pages: n))
  ...
  def test_defaults_to_rendering_2_pages_on_each_side_of_current
    ...
    render_inline(Primer::PaginationComponent.new(page: 10, page_count: 20))
  ...
  def test_renders_n_pages_on_each_side_of_current_when_specified
    ...
    render_inline(Primer::PaginationComponent.new(page: 10, page_count: 20, surrounding_pages: n))
  ...
  def test_href_builder_defaults_to_hashtag_number
    render_inline(Primer::PaginationComponent.new(page: 1, page_count: 2))
  ...
  def test_calls_custom_href_builder
    ...
    render_inline(Primer::PaginationComponent.new(page: 1, page_count: 2, href_builder: builder))
  ...
  def test_renders_left_gap_if_surround_pages_arent_part_of_left_margin
    render_inline(Primer::PaginationComponent.new(page: 3, page_count: 3, surrounding_pages: 1, margin_pages: 1))

    assert_selector("span.gap", count: 1)
  end

  def test_renders_right_gap_if_surround_pages_arent_part_of_right_margin
    render_inline(Primer::PaginationComponent.new(page: 1, page_count: 3, surrounding_pages: 1, margin_pages: 1))

    assert_selector("span.gap", count: 1)
  end

  def test_renders_both_gaps_if_surround_pages_arent_part_of_any_margin
    render_inline(Primer::PaginationComponent.new(page: 3, page_count: 5, surrounding_pages: 1, margin_pages: 1))

    assert_selector("span.gap", count: 2)
  end

  def test_renders_no_if_surround_pages_aren_part_of_both_margins
    render_inline(Primer::PaginationComponent.new(page: 2, page_count: 3, surrounding_pages: 1, margin_pages: 1))
