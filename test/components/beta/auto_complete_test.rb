...
class PrimerAutoCompleteTest < Minitest::Test
  ...
  def test_renders_with_icon
    render_inline Primer::Beta::AutoComplete.new(label_text: "Fruits", src: "/url", list_id: "my-list-id", input_id: "test-input", with_icon: true)
  ...
  def test_renders_screen_reader_label_with_icon_and_non_visible_label
    render_inline Primer::Beta::AutoComplete.new(label_text: "Fruits", src: "/url", list_id: "my-list-id", input_id: "test-input", is_label_visible: false, with_icon: true)
  ...
  def test_wraps_icon_and_input_when_with_icon_true
    render_inline Primer::Beta::AutoComplete.new(label_text: "Cool Fruits", src: "/url", input_id: "test-input", list_id: "my-list-id", with_icon: true)
  ...
  def test_applies_correct_class_when_is_label_inline
    render_inline Primer::Beta::AutoComplete.new(label_text: "Cool Fruits", src: "/url", input_id: "test-input", list_id: "my-list-id", is_label_inline: true)
