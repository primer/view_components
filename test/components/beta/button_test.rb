...
class PrimerBetaButtonTest < Minitest::Test
  ...
  def test_renders_content
    render_inline(Primer::Beta::Button.new) { "content" }
  ...
  def test_renders_a_without_button_role
    render_inline(Primer::Beta::Button.new(tag: :a)) { "content" }
  ...
  def test_renders_summary_without_button_role
    render_inline(Primer::Beta::Button.new(tag: :summary)) { "content" }
  ...
  def test_renders_href
    render_inline(Primer::Beta::Button.new(href: "www.example.com")) { "content" }
  ...
  def test_falls_back_when_type_isn_t_valid
    without_fetch_or_fallback_raises do
      render_inline(Primer::Beta::Button.new(scheme: :invalid)) { "content" }
  ...
  def test_renders_with_the_css_class_mapping_to_the_provided_type
    render_inline(Primer::Beta::Button.new(scheme: :primary)) { "content" }
  ...
  def test_falls_back_when_size_isn_t_valid
    without_fetch_or_fallback_raises do
      render_inline(Primer::Beta::Button.new(size: :invalid)) { "content" }
  ...
  def test_renders_with_the_css_class_size_mapping_to_the_provided_size
    render_inline(Primer::Beta::Button.new(size: :small)) { "content" }

    assert_selector(".btn.btn-sm")
  end

  def test_renders_with_the_css_class_size_mapping_to_the_provided_variant
    render_inline(Primer::Beta::Button.new(variant: :small)) { "content" }
  ...
  def test_renders_button_block
    render_inline(Primer::Beta::Button.new(block: true)) { "content" }

    assert_selector(".btn.btn-block")
  end

  def test_renders_button_block_with_scheme
    render_inline(Primer::Beta::Button.new(block: true, scheme: :primary)) { "content" }

    assert_selector(".btn.btn-primary.btn-block")
  end

  def test_renders_leading_visual
    render_inline(Primer::Beta::Button.new) do |c|
  ...
  def test_renders_dropdown_caret
    render_inline(Primer::Beta::Button.new(dropdown: true).with_content("Button"))
