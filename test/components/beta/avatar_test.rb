...
class PrimerBetaAvatarTest < Minitest::Test
  ...
  def test_renders_an_avatar
    render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github"))
  ...
  def test_falls_back_when_size_isn_t_valid
    without_fetch_or_fallback_raises do
      render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github", size: 1_000_000_000))
  ...
  def test_defaults_adds_small_modifier_when_size_is_less_than_threshold
    render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github", size: Primer::Beta::Avatar::SMALL_THRESHOLD - 4))

    assert_selector("img.avatar.avatar-small")
  end

  def test_defaults_does_not_add_small_modifier_when_size_is_greater_than_threshold
    render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github", size: Primer::Beta::Avatar::SMALL_THRESHOLD + 8))
  ...
  def test_adds_custom_classes
    render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github", classes: "custom-class"))

    assert_selector("img.avatar.custom-class")
  end

  def test_sets_size_height_and_width
    render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github", size: 24))

    assert_selector("img.avatar[size=24][height=24][width=24]")
  end

  def test_squared_avatar
    render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github", shape: :square))
  ...
  def test_renders_link_wrapper
    render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github", href: "#given-href"))
  ...
  def test_defaults_circle_link_wrapper
    render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github", href: "#"))
  ...
  def test_squared_link_wrapper
    render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github", href: "#", shape: :square))
  ...
  def test_adds_small_modifier_to_link_wrapper_when_size_is_less_than_threshold
    render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github", href: "#", size: Primer::Beta::Avatar::SMALL_THRESHOLD - 4))
  ...
  def test_does_not_add_small_modifier_to_link_wrapper_when_size_is_greater_than_threshold
    render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github", href: "#", size: Primer::Beta::Avatar::SMALL_THRESHOLD + 8))
  ...
  def test_adds_custom_classes_to_link_wrapper
    render_inline(Primer::Beta::Avatar.new(src: Primer::ExampleImage::BASE64_SRC, alt: "github", href: "#", classes: "custom-class"))
