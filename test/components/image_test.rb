...
class PrimerImageTest < Minitest::Test
  ...
  def test_render_without_loading_attribute_by_default
    render_inline(Primer::Image.new(src: Primer::ExampleImage::BASE64_SRC, alt: "alt"))
  ...
  def test_lazy_loading
    render_inline(Primer::Image.new(src: Primer::ExampleImage::BASE64_SRC, alt: "alt", lazy: true))
  ...
  def test_restricts_allowed_system_arguments
    with_raise_on_invalid_options(true) do
      error = assert_raises(ArgumentError) do
        render_inline(Primer::Image.new(src: Primer::ExampleImage::BASE64_SRC, alt: "alt", tag: :div))
      end
