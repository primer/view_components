  ...
  module Alpha
    class SkeletonBoxTest < Minitest::Test
      ...
      def test_renders_box_with_no_dimensions_by_default
        render_inline(Primer::Alpha::SkeletonBox.new)
      ...
      def test_renders_box_with_width_only
        render_inline(Primer::Alpha::SkeletonBox.new(width: "16px"))
      ...
      def test_renders_box_with_height_only
        render_inline(Primer::Alpha::SkeletonBox.new(height: "16px"))
      ...
      def test_renders_box_with_both_dimensions
        render_inline(Primer::Alpha::SkeletonBox.new(width: "16px", height: "16px"))
