...
class PrimerAlphaNavigationListTest < Minitest::Test
  ...
  def test_aria_labels_for_section_list
    ...
    assert_selector(".ActionList-sectionDivider[id='#{section_id}']", text: "List")
  ...
  def test_subitems
    ...
    assert_selector(".ActionList-item.ActionList-item--hasSubItem[aria-haspopup='true']", text: "Item") do
  ...
  def test_selected_subitem
    ...
    assert_selector(".ActionList-item.ActionList-item--hasSubItem[aria-expanded='false']", text: "Item 1")

    assert_selector(".ActionList-item.ActionList-item--hasSubItem[aria-expanded='true']", text: "Item 2") do
      assert_selector("ul.ActionList.ActionList--subGroup") do
        assert_selector("li.ActionList-item.ActionList-item--subItem") do
