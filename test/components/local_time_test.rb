...
class PrimerLocalTimeTest < Minitest::Test
  ...
  def test_renders
    ...
    assert_selector("local-time[datetime=\"2014-06-01T13:05:07+00:00\"][year=\"numeric\"][month=\"short\"][day=\"numeric\"][hour=\"numeric\"][minute=\"numeric\"][second=\"numeric\"]", text: "June 1, 2014 13:05 +00:00")
  end
