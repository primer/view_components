...
class PrimerAutoCompleteTest < Minitest::Test
  ...
  def test_raises_if_no_label_or_aria_label_or_aria_labelled_by_provided_for_input
    err = assert_raises ArgumentError do
      render_inline Primer::AutoComplete.new(src: "/url", list_id: "my-list-id", input_id: "test-input") do |component|
        component.input(name: "input")
      end
    end
  ...
  def test_renders_with_icon
    render_inline Primer::AutoComplete.new(src: "/url", list_id: "my-list-id", "aria-label": "Fruits", input_id: "test-input") do |component|
      component.input(name: "input")
      component.icon(icon: :person)
    end
