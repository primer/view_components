  ...
  def test_renders_panels_and_tab_container
    ...
    assert_selector("tab-container") do
      assert_selector("div.UnderlineNav") do
        assert_selector("div.UnderlineNav-body[role='tablist'][aria-label='label'][aria-controls='tab-1']") do
          assert_selector("button.UnderlineNav-item[role='tab'][aria-selected='true'][aria-controls='tab-2']", text: "Tab 1")
          assert_selector("button.UnderlineNav-item[role='tab'][aria-controls='tab-3']", text: "Tab 2")
        end
        assert_selector("div.UnderlineNav-actions", text: "Actions content")
      end
      assert_selector("div[id='tab-1'][role='tabpanel']", text: "Panel 1")
      assert_selector("div[id='tab-2'][role='tabpanel']", text: "Panel 2", visible: false)
    end
  end
