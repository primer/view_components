...
class PrimerAlphaButtonMarketingComponentTest < Minitest::Test
  include Primer::ComponentTestHelpers

  def test_renders_content
    render_inline(Primer::Alpha::ButtonMarketingComponent.new) { "content" }
  ...
  def test_renders_a_as_a_button
    render_inline(Primer::Alpha::ButtonMarketingComponent.new(tag: :a)) { "content" }

    assert_selector("a.btn-mktg[role='button']")
  end

  def test_renders_href
    render_inline(Primer::Alpha::ButtonMarketingComponent.new(href: "www.example.com")) { "content" }

    assert_selector("button[href='www.example.com']")
  end

  def test_renders_with_the_css_class_mapping_to_the_provided_type
    render_inline(Primer::Alpha::ButtonMarketingComponent.new(scheme: :primary)) { "content" }

    assert_selector(".btn-mktg.btn-primary-mktg")
  end

  def test_renders_with_the_css_class_variant_mapping_to_the_provided_variant
    render_inline(Primer::Alpha::ButtonMarketingComponent.new(variant: :large)) { "content" }
