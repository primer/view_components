...
class PrimerComponentTest < Minitest::Test
  ...
  COMPONENTS_WITH_ARGS = [
    ...
    [Primer::Alpha::NavigationList, { aria: { label: "foo" } }],
    [Primer::Alpha::NavigationList::Heading, { section_id: "foo" }],
    [Primer::Alpha::NavigationList::Item, { href: "/foo" }],
    [Primer::Alpha::NavigationList::Section, { aria: { label: "foo" } }],
    ...
    [Primer::Beta::AutoComplete, { label_text: "Fruits", src: "Foo", list_id: "Bar", input_id: "input-id" }],
