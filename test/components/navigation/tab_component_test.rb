...
class PrimerNavigationTabComponentTest < Minitest::Test
  ...
  def test_renders_title
    render_inline Primer::Navigation::TabComponent.new(parent_id: "id", index: 0) do |c|
      c.text { "Title" }
    end
  ...
  def test_renders_role_only_if_with_panel
    render_inline Primer::Navigation::TabComponent.new(parent_id: "id", index: 0, with_panel: true) do |c|
      c.text { "Title" }
    end
  ...
  def test_renders_custom_content
    render_inline Primer::Navigation::TabComponent.new(parent_id: "id", index: 0) do
      "Custom content"
    end
  ...
  def test_renders_aria_current_if_link_and_selected
    render_inline Primer::Navigation::TabComponent.new(parent_id: "id", index: 0, selected: true) do |c|
      c.text { "Title" }
    end
  ...
  def test_renders_aria_selected_if_button_and_selected
    render_inline Primer::Navigation::TabComponent.new(parent_id: "id", index: 0, selected: true, with_panel: true) do |c|
      c.text { "Title" }
    end
  ...
  def test_renders_icon_with_classes
    render_inline Primer::Navigation::TabComponent.new(parent_id: "id", index: 0, icon_classes: "custom-class") do |c|
      c.icon(icon: :star)
    end
  ...
  def test_renders_inside_list
    render_inline Primer::Navigation::TabComponent.new(parent_id: "id", index: 0, list: true) do |c|
      c.text { "Title" }
    end
