  ...
  module Alpha
    ...
    class BannerPreview < ViewComponent::Preview
      ...
      def full_width_with_dismissible
        render(Primer::Alpha::Banner.new(full: true, dismissible: true)) { "This is a full width banner that is dismissible." }
      end
      ...
      def full_width_with_action_button
        render(Primer::Alpha::Banner.new(full: true, dismissible: true)) do |component|
          ...
          "This is a full width banner that is dismissible and has an action button."
        end
      end
      ...
      # @label Full width with long description
      def full_width_with_long_description
        render(
          Primer::Alpha::Banner.new(
            full: true,
            dismissible: true,
            description: "It has a long (over 120 characters) description. It will center the content and add a max-width so that the text doesn't exceed too long and starts wrapping onto muliple lines."
          )
        ) do |component|
          component.with_action_button(size: :small) { "Take action" }
          "This is a full width banner."
