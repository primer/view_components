...
module ERBLint
  module Linters
    ...
    class ButtonComponentMigrationCounter < BaseLinter
      ...
      MESSAGE = "We are migrating buttons to use [Primer::Beta::Button](https://primer.style/view-components/components/button), please try to use that instead of raw HTML."
