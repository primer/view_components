...
module Primer
  ...
  #   <%= render Primer::ConditionalBaseComponent.new(condition: true, tag: :span, class: "foobar")) do %>
  #     <%# also rendered %>
  ...
  #   <%= render(Primer::ConditionalBaseComponent.new(condition: false, tag: :span, class: "foobar")) do %>
  ...
  class ConditionalBaseComponent < Primer::Component
