/* NOTE: This web component exists to support the older Primer::Experimental::Dialog
 * component in dotcom and should not be removed until all those instances have been
 * migrated to Primer::Alpha::Dialog.
 */
