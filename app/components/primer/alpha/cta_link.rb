...
module Primer
  module Alpha
    ...
    class CtaLink < Primer::Component
      ...
      def initialize(href:, scheme: Primer::ButtonComponent::DEFAULT_SCHEME, **system_arguments)
        ...
        @system_arguments[:scheme] = fetch_or_fallback(SCHEME_OPTIONS, scheme, Primer::ButtonComponent::DEFAULT_SCHEME)
      end
