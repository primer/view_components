  ...
  module OpenProject
    ...
    class PageHeader < Primer::Component
      ...
      renders_one :title, lambda { |tag: :h1, **system_arguments|
        ...
        system_arguments[:classes] = class_names(system_arguments[:classes], "OpPageHeader-title")
      ...
      renders_one :description, lambda { |**system_arguments|
        ...
        system_arguments[:classes] = class_names(system_arguments[:classes], "OpPageHeader-description")
      ...
      renders_one :actions, lambda { |**system_arguments|
        deny_tag_argument(**system_arguments)
        system_arguments[:tag] = :div
        system_arguments[:classes] = class_names(system_arguments[:classes], "OpPageHeader-actions")
