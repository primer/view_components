...
class ComponentGenerator < Thor::Group
  ...
  def create_system_test
    ...
    template("templates/#{status_template_path}system_test_preview.rb.tt", "lookbook/test/components/previews/#{status_path}#{underscore_name}_preview.rb") if js_package_name
  end
