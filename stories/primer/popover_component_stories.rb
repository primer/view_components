...
class Primer::PopoverComponentStories < ViewComponent::Storybook::Stories
  ...
  story(:popover) do
    ...
    body { "Message about this particular piece of UI." }
  end
  ...
  story(:large_popover) do
    heading { "Popover heading" }
    body(large: true) { "Message about this particular piece of UI." }
  end
  ...
  (
    ...
    story("popover_#{caret}".to_sym) do
      heading { "Popover heading" }
      body(caret: caret) { "Message about this particular piece of UI." }
    end
  end
end
