...
require "primer/beta/base_layout"

class Primer::Beta::BaseLayoutStories < ViewComponent::Storybook::Stories
  ...
  story(:layout) do
    controls do
      ...
      select(:inner_spacing, Primer::Beta::BaseLayout::INNER_SPACING_OPTIONS, Primer::Beta::BaseLayout::INNER_SPACING_DEFAULT)
