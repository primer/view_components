...
<Example src="  <a id='default-0' aria-current='page'>          <span>Selected</span>    </a>  <a id='default-1'>          <span>Not selected</span>    </a>" />
...
<Example src="  <a id='with-icons-and-counters-0'>    <svg class='octicon octicon-star' height='16' viewBox='0 0 16 16' version='1.1' width='16' aria-hidden='true'><path fill-rule='evenodd' d='M8 .25a.75.75 0 01.673.418l1.882 3.815 4.21.612a.75.75 0 01.416 1.279l-3.046 2.97.719 4.192a.75.75 0 01-1.088.791L8 12.347l-3.766 1.98a.75.75 0 01-1.088-.79l.72-4.194L.818 6.374a.75.75 0 01.416-1.28l4.21-.611L7.327.668A.75.75 0 018 .25zm0 2.445L6.615 5.5a.75.75 0 01-.564.41l-3.097.45 2.24 2.184a.75.75 0 01.216.664l-.528 3.084 2.769-1.456a.75.75 0 01.698 0l2.77 1.456-.53-3.084a.75.75 0 01.216-.664l2.24-2.183-3.096-.45a.75.75 0 01-.564-.41L8 2.694v.001z'></path></svg>      <span>Tab</span>    </a>  <a id='with-icons-and-counters-1'>    <svg class='octicon octicon-star' height='16' viewBox='0 0 16 16' version='1.1' width='16' aria-hidden='true'><path fill-rule='evenodd' d='M8 .25a.75.75 0 01.673.418l1.882 3.815 4.21.612a.75.75 0 01.416 1.279l-3.046 2.97.719 4.192a.75.75 0 01-1.088.791L8 12.347l-3.766 1.98a.75.75 0 01-1.088-.79l.72-4.194L.818 6.374a.75.75 0 01.416-1.28l4.21-.611L7.327.668A.75.75 0 018 .25zm0 2.445L6.615 5.5a.75.75 0 01-.564.41l-3.097.45 2.24 2.184a.75.75 0 01.216.664l-.528 3.084 2.769-1.456a.75.75 0 01.698 0l2.77 1.456-.53-3.084a.75.75 0 01.216-.664l2.24-2.183-3.096-.45a.75.75 0 01-.564-.41L8 2.694v.001z'></path></svg>      <span>Tab</span>    <span title='10' class='Counter '>10</span></a>  <a id='with-icons-and-counters-2'>          <span>Tab</span>    <span title='10' class='Counter '>10</span></a>" />
...
<Example src="<li class='d-flex'>  <a id='inside-a-list-0'>          <span>Tab</span>    </a></li>" />
...
<Example src="  <a id='with-custom-html-0'>            <div>    This is my <strong>custom HTML</strong>  </div>    </a>" />
...
| :- | :- | :- | :- |
| `parent_id` | `Boolean` | N/A | The id of the parent element. |
| `index` | `Int` | N/A | Index of the tab. |
