...
<Example src="  <div class='tabnav '>    <nav class='tabnav-tabs '>        <a href='#' aria-current='page' class='tabnav-tab '>      Tab 1  </a>        <a href='#' class='tabnav-tab '>      Tab 2  </a>        <a href='#' class='tabnav-tab '>      Tab 3  </a></nav></div>" />
