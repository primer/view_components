...
<Example src="<tab-container>  <div id='with-panels' class='UnderlineNav '>    <div role='tablist' aria-label='With panels' class='UnderlineNav-body '>          <button id='with-panels-0' type='button' role='tab' aria-controls='with-panels-0-panel' aria-selected='true' class='UnderlineNav-item '>          <span>Item 1</span>    </button>          <button id='with-panels-1' type='button' role='tab' aria-controls='with-panels-1-panel' class='UnderlineNav-item '>          <span>Item 2</span>    </button></div>      <div class='UnderlineNav-actions '>    <button type='button' class='btn '>Button!</button></div></div>      <div role='tabpanel' aria-labelledby='with-panels-0' id='with-panels-0-panel'>      Panel 1</div>      <div role='tabpanel' hidden='hidden' aria-labelledby='with-panels-1' id='with-panels-1-panel'>      Panel 2</div></tab-container>" />
