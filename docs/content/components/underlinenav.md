...
<%= render(Primer::UnderlineNavComponent.new(label: "With panels", with_panel: true)) do |component| %>
  <% component.tab(selected: true, id: "tab-1", panel_id: "panel-1") do |t| %>
    ...
    <% end %>
  <% end %>
  <% component.tab(id: "tab-2", panel_id: "panel-1") do |t| %>
    <% t.text { "Item 2" } %>
    <% t.panel do %>
      Panel 2
    <% end %>
