...
<Example src="<li role='option' data-autocomplete-value='value' aria-selected='' data-view-component='' class='autocomplete-item'>  Selected</li><li role='option' data-autocomplete-value='value' data-view-component='' class='autocomplete-item'>  Not selected</li>" />
